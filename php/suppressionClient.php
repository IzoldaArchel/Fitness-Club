<?php
/**
 * @file supressionClient.php
 * @author Kolomiets Elena
 * @version 1.0
 * @date 05 Fevrier 2019
 * @brief La page qui permet à l'administrateur de supprimer un client.
*/
...
<body>
    ...
    <main>
        ...
        <section>
            <?php if(!$succes) : ?>
            <p>Confirmez la suppression d'un client :</p>
