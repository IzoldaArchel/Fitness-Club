<?php
/**
 * @file modifierAnimateur.php
 * @author Kolomiets Elena
 * @version 1.0
 * @date xx Janvier 2019
 * @brief La page qui permet à l'administrateur de modifier un animateur.
*/
...
if (isset($_POST['envoi'])) {
    ...
    if (count($erreurs) === 0) {
        if (modifierUtilisateur($conn, $id, $utilisateur_nom, $utilisateur_prenom, $utilisateur_adress,                      $utilisateur_courriel, $utilisateur_motdepass) === 1) {
            $retSQL="Modification effectué.<br><h2>Pour effectuer une nouvelle modification veuiller retourner aux <a href='gererAnimateurs'>Animateurs</a></h2>";
            $succes = 1;
             } else {
    ...
    // lecture de l'animateur à modifier, à la première ouverture de la page
...
?>
    ...
    <body>
        ...
        <main>
            <div class="admin">
                <h1>Modifiez les données de l’animateur </h1>
