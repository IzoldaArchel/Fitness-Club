...
session_start(); 
$courriel = $motdepass = '';
$courrielErr = $motdepassErr = '';
if(!isset($_SESSION['identifiant_utilisateur'])) {
if (isset($_POST['envoi'])) {
    
    if (empty($_POST['courriel'])) {
        $courrielErr = 'Please Enter This Value to Submit Form';
    }else{
        $courriel = $_POST['courriel'];
    }
    if (empty($_POST['courriel'])) {
        $motdepassErr = 'Please Enter This Value to Submit Form';
    }else{
         ...
         <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <form action="" method="POST" name="dossier">
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Courriel</label>
                        ...
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Courriel</label>
                            <input type="text" name="motdepass" placeholder=" mot de passe" />
                            <div class="text-danger">
                                <?= $motdepassErr;?>
                            </div>
                        </div>
                        <div class="col-md-6 offset-md-6 btn-lg" style="margin-top: 20px; text-align:end;">
                            <button class="btn btn-success" type="submit" name="envoi">connectez</button>
                        </div>
                    </form>
                </div>
            </div>
         ...
         <div class="footer">
            ...
            <div>
               <p>
                  ...
                  <a href="#"><img src="../images/twiter.png" alt="fb" /></a>
               </p>
