<?php
/**
 * @file detailsActivite.php
 * @author Kolomiets Elena
 * @version 1.0
 * @date 26 Janvier 2019
 * @brief La page qui permet de voir les détails d'une activité.
*/
        ...
        <div class="admin">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $row['genre_nom'] ?>
                    </td>
                    <td>
                        <?php echo $row['animateur'] ?>
                    </td>
                    <td>
                        <?php echo $row['activite_max_inscris'] ?>
                    </td>
                    <td>
