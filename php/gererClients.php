<?php
/**
 * @file gererClients.php
 * @author Kolomiets Elena
 * @version 1.0
 * @date xx Janvier 2019
 * @brief La page qui affiche la liste des clients.
*/
        ...
        <div class="admin">
            ...
            <form method="POST" action='clients.php'>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <?php echo $client['utilisateur_id'] ?>
                        </td>
                        <td>
                            <?php echo $client['utilisateur_nom'] ?>
                        </td>
                        <td>
                            <?php echo $client['utilisateur_prenom'] ?>
                        </td>
                        <td><a href="detailsClient.php?id=<?php echo $client['utilisateur_id'] ?>">détails</a></td>
                        <td><a href="modifierClient.php?id=<?php echo $client['utilisateur_id'] ?>">modifier</a></td>

                        <td><a href="suppressionClient.php?id=<?php echo $client['utilisateur_id'] ?>">supprimer</a></td>
                ...
                <a href="registration.php"><input class="ajout" type="button" name="ajout" value="ajouter" /></a>
            </form><br><br><br><br><br>
        </div>
